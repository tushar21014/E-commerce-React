      ...
      <div>
        {filtered.map(obj => {
          return <div key={obj.id}>
            ...
            deal_price = {obj.Deal_price} mrp = {obj.MRP} offer1 = {obj.Offer1} offer1content = {obj.Offer1content.slice(0,50)} model = {obj.ModelName} brand = {obj.Brand}
            />

          </div>
        })}
        {/* {this.state.tushar.map(obj => {
          return <div key={obj.id} >
